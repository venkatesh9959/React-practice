                  ...
                  <div className="card-content">
                    <div className="card-body">
                      <div className="form-horizontal form-simple">
                        ...
                        <Modal show={open} onHide={closeModelPopup}>
                          <Modal.Header closeButton>
                            <Modal.Title className="modelTitle">Alert</Modal.Title>
                          </Modal.Header>
                          <Modal.Body>
                          ...
                          <Modal.Footer>
                            <Button
                              type="button"
                              onClickHandler={() => closeModelPopup()}
                              buttonText="Close"
                        ...
                        <Link to="/Register" className="card-link">
                          <Button
                            addClass="btn-primarybtn btn-outline-info btn-lg btn-block form-group"
                            buttonText="Register"
                          />
                        </Link>
                      </div>
